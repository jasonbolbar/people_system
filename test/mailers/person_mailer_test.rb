...
describe PersonMailer do
  ...
  test 'new person mail' do
    body = PersonMailer.new_person_email(@recipient,{'new_person_id' => @user.id}).body.to_s
  ...
  test 'deleted person mail' do
    body = PersonMailer.deleted_person_email(@recipient,{'first_name' => @user.first_name, 'last_name' => @user.last_name}).body.to_s
    assert_match Regexp.new("Hello #{@recipient.first_name} #{@recipient.last_name}"), body
